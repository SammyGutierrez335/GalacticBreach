...
function clear() {
  ctx.clearRect(0, 0, canvas.width, canvas.canvas.height);
}
...
function draw() {
  ctx.fillRect(75, 0, 800, canvas.height, "black");

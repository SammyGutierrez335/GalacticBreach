...
export default class Game {
  ...
  handleAudioToggles() {
    let volume = 1
    this.sfxMuted ? volume = 0.0 : volume = 1.0

    if (this.sfxMuted) {
      this.bulletSfx.volume = 0.0
      this.damage1.volume = 0.0
      this.damage2.volume = 0.0
      this.damage3.volume = 0.0
    }

    if (this.musicMuted) {
      this.spaceAmbience.volume = 0.0
    }
  }

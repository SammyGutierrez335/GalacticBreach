      ...
      if (this.enemies.length <= this.maxEnemies) {
        ...
        for (let i = 0; i < this.enemies.length; i++) {
          ...
          if (enemy.despawning[0]) {
            let explosionFrameX = enemy.despawning[1] * 177
            let explosionFrameY = enemy.despawning[1] * 192
            ctx.drawImage(enemyImage,
              explosionFrameX, explosionFrameY, 500, 500,
              enemy.x - enemy.speed, enemy.y - 50, 125, 125)
            } else {
              ctx.drawImage(enemyImage,
